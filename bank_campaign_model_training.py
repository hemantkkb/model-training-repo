...
bucket = storage_client.bucket("bucket-model-governance")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "model-governance-kpmg-ggn.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://bucket-model-governance/bank_campaign_data/bank-additional.csv"
    model_name='xgboost'
